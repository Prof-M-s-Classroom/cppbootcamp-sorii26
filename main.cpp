...
// Step 2: Function to modify robot (pass by value)
   void modifyRobotByValue(Robot myRobot) {
       myRobot.setBatteryLife(77);
       cout<< "Inside function using by value"<<myRobot.getBatteryLife()<<endl;
   }

// Step 3: Function to modify robot (pass by reference)
    void modifyRobotByReference(Robot &myRobot) {
       myRobot.setBatteryLife(100);
       cout<< "Inside function using by reference"<<myRobot.getBatteryLife()<<endl;
   }
